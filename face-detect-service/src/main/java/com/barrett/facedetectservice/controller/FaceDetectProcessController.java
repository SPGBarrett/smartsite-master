...
public class FaceDetectProcessController {
    ...
    /**
     * @Description:  Update recorded face information from device one by one
     * @Param:
     * @return:
     * @Author: Barrett
     * @Date:
     */
    @RequestMapping(value = {"/UpdateFaceInfo"}, method = {RequestMethod.GET})
    public int updateFaceInfo() {
        return 0;
    }
