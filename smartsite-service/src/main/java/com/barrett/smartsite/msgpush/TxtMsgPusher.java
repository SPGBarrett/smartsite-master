 ...
 **/
public class TxtMsgPusher {
    // Define variables:
    protected static final Logger LOG = LoggerFactory.getLogger(TxtMsgPusher.class);
    private static final String appkey = "bf0a769e1d3e76a7917aa14b";
    private static final String masterSecret = "f29c211ab77a054a53e5c297";
    private static final String devKey = " 8301c3a7d951bb333da66df4";
    private static final String devSecret = "710039a694a73d5ff6a08a12";

    //
    public static void testSendSMSCode() {
        SMSClient client = new SMSClient(masterSecret, appkey);
        SMSPayload payload = SMSPayload.newBuilder()
                .setMobileNumber("18627886419")
                .setTempId(1)
                .setSignId(10734)
                .build();
        try {
